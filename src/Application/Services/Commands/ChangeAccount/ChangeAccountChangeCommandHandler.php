...
class ChangeAccountChangeCommandHandler extends CommandHandler
{
    ...
    /**
     * @param  ChangeAccountChangeCommand  $command
     *
     * @return bool
     * @throws Throwable
     */
    public function handle(ChangeAccountChangeCommand $command) : bool
    {
        ...
        try {
            ...
            $this->changeAccountService->change($user, $command);
